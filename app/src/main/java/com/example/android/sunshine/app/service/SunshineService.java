...
/**
 * Created by Sheraz on 6/30/2015.
 */
public class SunshineService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent != null) {
            params = intent.getStringArrayExtra(LOCATION_QUERY_EXTRA);
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        serviceIntent.putExtra(LOCATION_QUERY_EXTRA, intent.getStringArrayExtra(LOCATION_QUERY_EXTRA));
