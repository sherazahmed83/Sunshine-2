...
public class MainActivity extends AppCompatActivity implements ForecastFragment.OnItemSelectedListenerCallback{
     ...
     */
    static final String PROJECT_NUMBER = "268984859695";
...
//        }
    ...
    private void storeRegistrationId(Context context, String regId) {
        ...
        Log.d(LOG_TAG, "Saving regId on app version " + appVersion + " registration id = " + regId);
