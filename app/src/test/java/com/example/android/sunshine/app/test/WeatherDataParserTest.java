...
import com.example.android.sunshine.app.com.example.android.sunshine.app.json.WeatherDataParser;
import com.example.android.sunshine.app.test.data.BuildConfig;
import com.example.android.sunshine.app.test.data.ShadowSQLiteOpenHelper;
...
public class WeatherDataParserTest {
    ...
    public void testMountainViewThirdDay() throws JSONException {
        Assert.assertEquals("", 14.1, WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_MTV_JUN_4, 2), 0);
    }
    @Test
    public void testFremontLastDay() throws JSONException {
        Assert.assertEquals("", 16.75, WeatherDataParser.getMaxTemperatureForDay(WEATHER_DATA_FREMONT_JUN_4, 6), 0);
    }
