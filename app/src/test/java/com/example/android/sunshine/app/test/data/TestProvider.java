...
@Config( shadows = { ShadowSQLiteOpenHelper.class }, constants = BuildConfig.class, manifest = Config.NONE)/*, manifest = "app/src/main/AndroidManifest.xml", emulateSdk=21*/
...
//    @Override
    public void setUp() throws Exception {
        final ContentProvider provider = new WeatherProvider();
        provider.onCreate();
        ShadowContentResolver.registerProvider(WeatherContract.CONTENT_AUTHORITY, provider);
...
//    @Test
    public void testProviderRegistry() {
        ...
        ComponentName componentName = new ComponentName(RuntimeEnvironment.application.getPackageName()/*mContext.getPackageName()*/,
...
//        ContentResolver resolver = RuntimeEnvironment.application.getContentResolver();
        ...
        String type = resolver.getType(WeatherEntry.CONTENT_URI);
        ...
        type = resolver.getType(LocationEntry.CONTENT_URI);
...
//        SQLiteDatabase db = dbHelper.getWritableDatabase();
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= millisecondsInADay ) {
            ...
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP, 75.0 + i);
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP, 65.0 - i);
